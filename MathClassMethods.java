...
public class MathClassMethods{
	public static void main(String[] args){
		...
		System.out.println("To calculate area of a crircle");
		
		System.out.print("Enter the radius of the circle: ");
		int radius = input.nextInt();
		
		double areaOfCirlce = Math.PI * Math.pow(radius,2);
		
		System.out.printf("The area of the circle is %f%n",areaOfCirlce);
	}
}